function web(){var I='bootstrap',J='begin',K='gwt.codesvr.web=',L='gwt.codesvr=',M='web',N='startup',O='DUMMY',P=0,Q=1,R='iframe',S='position:absolute; width:0; height:0; border:none; left: -1000px;',T=' top: -1000px;',U='CSS1Compat',V='<!doctype html>',W='',X='<html><head><\/head><body><\/body><\/html>',Y='undefined',Z='readystatechange',$=10,_='Chrome',ab='eval("',bb='");',cb='script',db='javascript',eb='moduleStartup',fb='moduleRequested',gb='Failed to load ',hb='head',ib='meta',jb='name',kb='web::',lb='::',mb='gwt:property',nb='content',ob='=',pb='gwt:onPropertyErrorFn',qb='Bad handler "',rb='" for "gwt:onPropertyErrorFn"',sb='gwt:onLoadErrorFn',tb='" for "gwt:onLoadErrorFn"',ub='#',vb='?',wb='/',xb='img',yb='clear.cache.gif',zb='baseUrl',Ab='web.nocache.js',Bb='base',Cb='//',Db='user.agent',Eb='webkit',Fb='safari',Gb='msie',Hb=11,Ib='ie10',Jb=9,Kb='ie9',Lb=8,Mb='ie8',Nb='gecko',Ob='gecko1_8',Pb=2,Qb=3,Rb=4,Sb='selectingPermutation',Tb='web.devmode.js',Ub='21B4B8DFE5C7FA66CBB50DDA9B46F20C',Vb=':1',Wb=':2',Xb=':3',Yb=':',Zb='.cache.js',$b='loadExternalRefs',_b='end';var o=window;var p=document;r(I,J);function q(){var a=o.location.search;return a.indexOf(K)!=-1||a.indexOf(L)!=-1}
...
web.onScriptDownloaded=function(a){l(function(){m(a)})};r(eb,fb);var n=p.createElement(cb);n.src=k;if(web.__errFn){n.onerror=function(){web.__errFn(M,new Error(gb+code))}}p.getElementsByTagName(hb)[P].appendChild(n)}
web.__startLoadingFragment=function(a){return D(a)};web.__installRunAsyncCode=function(a){var b=v();var c=b.body;var d=b.createElement(cb);d.language=db;d.text=a;c.appendChild(d);c.removeChild(d)};function B(){var c={};var d;var e;var f=p.getElementsByTagName(ib);for(var g=P,h=f.length;g<h;++g){var i=f[g],j=i.getAttribute(jb),k;if(j){j=j.replace(kb,W);if(j.indexOf(lb)>=P){continue}if(j==mb){k=i.getAttribute(nb);if(k){var l,m=k.indexOf(ob);if(m>=P){j=k.substring(P,m);l=k.substring(m+Q)}else{j=k;l=W}c[j]=l}}else if(j==pb){k=i.getAttribute(nb);if(k){try{d=eval(k)}catch(a){alert(qb+k+rb)}}}else if(j==sb){k=i.getAttribute(nb);if(k){try{e=eval(k)}catch(a){alert(qb+k+tb)}}}}}__gwt_getMetaProperty=function(a){var b=c[a];return b==null?null:b};s=d;web.__errFn=e}
